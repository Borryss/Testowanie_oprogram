...
def test_simple_registration_and_send_message_in_private_messages(browser):
...
def test_simple_registration_and_send_message_and_check_All_dialogs_in_private_messages(browser):
...
def test_simple_registration_and_check_all_buttons_in_private_messages(browser):
