...
#     driver.quit()
#
# def test_simple_registration_and_post_in_main(browser):
#
...
#
# def test_simple_registration_and_post_and_delete_in_main(browser):
#
#     requests.get("http://127.0.0.1:8000/auth/delete-user/", params={"username": "uuu"})
#
#     browser.get("http://127.0.0.1:8000/auth/registration")
...
#     assert m_1 != m_2
#
# def test_simple_registration_and_post_and_edit_in_main(browser):
#
#     requests.get("http://127.0.0.1:8000/auth/delete-user/", params={"username": "uuu"})
#
#     browser.get("http://127.0.0.1:8000/auth/registration")
